...
from ..controllers.controllers import CustomerPortal, WebsiteSale

class mx_integritas_localizacion_cp_v12(models.Model):
    _inherit = ['res.partner']
    
    mx_integritas_colonia = fields.Selection ([
        ('', ''),
    ], string = 'Colonia',  default='')
