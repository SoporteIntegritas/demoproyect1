...
class AccountInvoice(models.Model):
    ...
    def _mostrar_campo(self):
        for record in self:
            ...
            record.mx_integritas_show_datos_addenda=record.partner_id.l10n_mx_edi_addenda
    ...
    def _set_datos_atomaticos(self):
        for record in self:
            ...
            if(len(record.mapped('invoice_line_ids.sale_line_ids.order_id.confirmation_date'))>0):
                record.mx_integritas_fecha_pedido_auto=record.mapped('invoice_line_ids.sale_line_ids.order_id.confirmation_date')[0]
